...
This seems like a obvious features to include for a wallpaper app...
...
(Right click on task bar icon -> `Change Wallpaper`)
> [!NOTE]
...
## Installation
Download the [latest release](Derpibooru-Wallpaper/releases/latest/DerpibooruWallpaper.zip), unzip to a folder you prefer.
> [!IMPORTANT]
...
## How to use
- Set your API Key
Although the program **CAN** function without an API Key, it is highly recommended to use one. (Every Derpibooru account has an API key)
